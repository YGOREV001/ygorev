--Cyborg Bass
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010279
local YGOREV_FUSION_MAT2=100010238
...
--Card Effects--START
--You can discard 1 Machine or WATER monster
function s.cfilter(c)
	return (c:IsRace(RACE_MACHINE) or c:IsAttribute(ATTRIBUTE_WATER)) and c:IsDiscardable() and c:IsAbleToGraveAsCost()
end
...
--Target up to 2 Spells/Traps on the field
function s.filter(c)
