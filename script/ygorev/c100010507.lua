--Violent Rain
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010381
...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	-- Cannot be destroyed by battle, except by a Level 7 or higher monster
	local e2=Effect.CreateEffect(c)
	e2:SetType(EFFECT_TYPE_SINGLE)
	e2:SetCode(EFFECT_INDESTRUCTABLE_BATTLE)
	e2:SetValue(function(_,c) return not (c:IsLevelAbove(7)) end)
	c:RegisterEffect(e2)
end
