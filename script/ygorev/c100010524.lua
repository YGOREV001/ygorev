--Wood Remains
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010054
...
function s.filter(c,e,tp)
	return c:IsRace(RACE_PLANT+RACE_ZOMBIE) and c:IsLevelBelow(3) and c:IsType(TYPE_NORMAL) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.atkfilter(c,e,tp)
	return c:IsCode(YGOREV_CARD_SKULLSERVANT) or c:IsRace(RACE_PLANT)
end
