...
--If a Warrior or FIRE monster you control would be destroyed by battle
function s.repfilter(c,tp)
	return c:IsFaceup() and (c:IsRace(RACE_WARRIOR) or c:IsAttribute(ATTRIBUTE_FIRE)) and c:IsLocation(LOCATION_MZONE) and c:IsControler(tp) 
