...
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010026
local YGOREV_FUSION_MAT2=100010183
...
function s.initial_effect(c)
	...
	c:RegisterEffect(e0)
	--All Fairy monsters on the field gain 500 ATK/DEF
...
--If this card you control is destroyed by battle or card effect and sent to your Graveyard: You can target 1 Fairy monster from your Graveyard, except "Winged Egg of New Life"; Special Summon it.
