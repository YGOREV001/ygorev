...
function s.initial_effect(c)
	...
	--You can only control 1 "Curse of Darkness"
	c:SetUniqueOnField(1,0,id)
	--Target 1 face-up monster your opponent controls; it loses 700 ATK, also it cannot attack or change its battle position
