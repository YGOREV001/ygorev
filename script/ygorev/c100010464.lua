--Darkfire Dragon
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010307
local YGOREV_FUSION_MAT2=100010165
...
--Card Effects--START
--When this card is Fusion Summoned: Destroy all face-up Spells/Traps on the field
function s.descon(e,tp,eg,ep,ev,re,r,rp)
	return (e:GetHandler():GetSummonType()&SUMMON_TYPE_FUSION)==SUMMON_TYPE_FUSION
end
function s.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	local g=Duel.GetMatchingGroup(aux.FaceupFilter(Card.IsType,TYPE_SPELL+TYPE_TRAP),tp,LOCATION_ONFIELD,LOCATION_ONFIELD,nil)
...
--While your LP is lower than your opponent's, this card's original ATK becomes 3000
function s.atkcon(e)
