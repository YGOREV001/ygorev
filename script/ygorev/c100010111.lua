...
function s.initial_effect(c)
	--WATER monsters you control gain 300 ATK/DEF.
	...
	c:RegisterEffect(e2)
	--If this card is discarded from your hand: You can Special Summon any number of "Ooguchi" from your hand or Deck.
...
--Special Summon any number of "Ooguchi" from your hand or Deck
