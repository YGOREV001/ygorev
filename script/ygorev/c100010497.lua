--Rock Warrior
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010332
local YGOREV_FUSION_MAT2=100010079
...
function s.initial_effect(c)
	...
	c:RegisterEffect(e0)
	--Rock monsters you control can attack while in face-up Defense Position. If they do, apply their DEF for damage calculation
...
--During the Standby Phase: All Rock monsters you control gain 200 DEF for each Rock monster you control.
