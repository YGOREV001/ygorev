...
--If a Fairy or LIGHT monster you control would be destroyed by battle
function s.repfilter(c,tp)
	return c:IsFaceup() and (c:IsRace(RACE_FAIRY) or c:IsAttribute(ATTRIBUTE_LIGHT)) and c:IsLocation(LOCATION_MZONE) and c:IsControler(tp) 
