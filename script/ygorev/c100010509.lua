--Warrior Lady of Tradition
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010389
...
--Card Effects--START
--When this card is Fusion Summoned: You can target 1 Equip Spell from your Graveyard; equip it to this card
function s.eqcon(e,tp,eg,ep,ev,re,r,rp)
	return (e:GetHandler():GetSummonType()&SUMMON_TYPE_FUSION)==SUMMON_TYPE_FUSION
end
function s.eqfilter(c,e,tp,ec)
	return c:IsType(TYPE_EQUIP) and c:IsCanBeEffectTarget(e) and c:CheckEquipTarget(ec)
end
...
--Send 1 Equip Spell you control to the Graveyard
