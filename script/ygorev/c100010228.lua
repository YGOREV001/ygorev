...
--If a Fiend or DARK monster you control would be destroyed by battle
function s.repfilter(c,tp)
	return c:IsFaceup() and (c:IsRace(RACE_FIEND) or c:IsAttribute(ATTRIBUTE_DARK)) and c:IsLocation(LOCATION_MZONE) and c:IsControler(tp) 
