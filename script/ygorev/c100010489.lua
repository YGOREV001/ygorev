--Wood Joker
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010052
local YGOREV_FUSION_MAT2=100010206
...
--You can change the battle position of this card
...
--If the battle position of this card is changed: You can target 1 card on the field; return it to the hand
function s.thfilter(c)
	return c:IsAbleToHand() and not c:IsLevelAbove(8)
end
