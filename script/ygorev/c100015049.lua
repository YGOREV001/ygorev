...
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010018
local YGOREV_FUSION_MAT2=100010018
local YGOREV_FUSION_MAT3=100010018
local YGOREV_NUMOFDIFFMATS=3
local YGOREV_CARD_BEWD=100010018
...
function s.rescon(sg,e,tp,mg)
	return Duel.GetLocationCountFromEx(tp,tp,sg,e:GetHandler())>0 and sg:IsExists(s.spfilter1,1,nil) and sg:IsExists(s.spfilter2,1,nil) and sg:IsExists(s.spfilter3,1,nil)
end
...
--Card Effects--START
--Discard 2 cards; this turn, this card can attack up to 3 times during each Battle Phase
