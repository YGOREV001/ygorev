...
function s.cftg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetFieldGroupCount(tp,0,LOCATION_DECK)>0 or Duel.GetFieldGroupCount(tp,LOCATION_DECK,0)>0 end
	Duel.SetTargetPlayer(tp)
end
function s.cfop(e,tp,eg,ep,ev,re,r,rp)
	--Look at up to 5 cards from the top of your Deck
	...
	--Look at up to 5 cards from the top of your opponent's Deck
	local p=Duel.GetChainInfo(0,CHAININFO_TARGET_PLAYER)
