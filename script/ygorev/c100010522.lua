--Stone Ghost
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010063
...
function s.tgfilter(c)
	return (c:IsRace(RACE_ZOMBIE) or c:IsAttribute(ATTRIBUTE_EARTH)) and c:IsType(TYPE_NORMAL) and c:IsAbleToGrave()
end
...
--Gains 500 ATK for each "Skull Servant" and each EARTH monster in your Graveyard
function s.atkfilter(c,e,tp)
	return c:IsCode(YGOREV_CARD_SKULLSERVANT) or c:IsAttribute(ATTRIBUTE_EARTH)
end
