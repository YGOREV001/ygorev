...
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010154
local YGOREV_FUSION_MAT2=100010382
...
--If this card was Fusion Summoned by using only Fusion Materials on the field, it cannot be destroyed by card effects
...
--If this card destroys a monster by battle: Inflict damage equal to that monster's DEF
