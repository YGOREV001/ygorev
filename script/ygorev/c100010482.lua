--Giga-Tech Wolf
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010047
...
--Card Effects--START
--If this card attacks, is unaffected other card effects on the field, until the end of the Damage Step 
function s.efilter(e,te)
	return te:GetOwner()~=e:GetOwner()
end
function s.econ(e)
	return Duel.GetAttacker()==e:GetHandler() and not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED)
end

--If this card is destroyed by battle and sent to the Graveyard: You can Special Summon 1 Level 4 or lower Beast or Machine monster from your Deck or Graveyard
function s.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsLocation(LOCATION_GRAVE)
end
function s.filter(c,e,tp)
	return c:IsRace(RACE_BEAST+RACE_MACHINE) and c:IsLevelBelow(4) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
