...
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010034
local YGOREV_FUSION_MAT2=100010003
...
--Card Effects--START
--You can discard 1 Fish monster
function s.cfilter(c)
	return c:IsRace(RACE_FISH) and c:IsDiscardable() and c:IsAbleToGraveAsCost()
end
