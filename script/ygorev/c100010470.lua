...
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010210
local YGOREV_FUSION_MAT2=100010226
...
--Card Effects--START
--Target 1 Attack Position monster on the field; change it to Defense Position. It cannot change its battle position the next turn
...
--Target 1 Defense Position monster on the field; Send it to the Graveyard
function s.filter2(c)
	return c:IsDefensePos()
end
function s.tgtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and chkc:IsAbleToGrave() and s.filter2(chkc) end
