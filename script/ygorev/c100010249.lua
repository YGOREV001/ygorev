...
--If a Insect or EARTH monster you control would be destroyed by battle
function s.repfilter(c,tp)
	return c:IsFaceup() and (c:IsRace(RACE_INSECT) or c:IsAttribute(ATTRIBUTE_EARTH)) and c:IsLocation(LOCATION_MZONE) and c:IsControler(tp) 
