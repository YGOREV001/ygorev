...
--While a player has more Traps in their Graveyard than the other one, that player cannot activate Traps
...
function s.adjustop(e,tp,eg,ep,ev,re,r,rp)
	local b1=Duel.GetMatchingGroupCount(Card.IsType,tp,LOCATION_GRAVE,0,nil,TYPE_TRAP)
	local b2=Duel.GetMatchingGroupCount(Card.IsType,tp,0,LOCATION_GRAVE,nil,TYPE_TRAP)
