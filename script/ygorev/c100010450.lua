--Fire Kraken
local s,id=GetID()
local YGOREV_FUSION_MAT1=100015009
local YGOREV_FUSION_MAT2=100010058
...
--If this card is Summoned: You can target 1 Set card on the field
...
--Gains 100 ATK/DEF for each FIRE or WATER monster in your Graveyard
function s.value(e,c)
	return Duel.GetMatchingGroupCount(Card.IsAttribute,c:GetControler(),LOCATION_GRAVE,0,nil,ATTRIBUTE_FIRE+ATTRIBUTE_WATER)*100
end
