...
local s,id=GetID()
local YGOREV_FUSION_MAT1=100015059
local YGOREV_FUSION_MAT2=100015041
...
--Card Effects--START
--Other monsters currently on the field cannot change their battle positions or attack.
function s.bktg(e,tp,eg,ep,ev,re,r,rp,chk)
