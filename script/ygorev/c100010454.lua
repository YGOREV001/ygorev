--Flower Wolf
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010050
...
--Card Effects--START
--If this card destroys an opponent's monster by battle and sends it to the Graveyard: Inflict 1500 damage to your opponent
