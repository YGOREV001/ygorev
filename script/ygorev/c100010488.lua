...
--Monsters your opponent controls cannot declare attacks on Plant monsters, except "Queen of Autumn Leaves"
function s.atktg(e,c)
	return c:IsFaceup() and c:GetCode()~=id and c:IsRace(RACE_PLANT)
end
--Card Effects--END