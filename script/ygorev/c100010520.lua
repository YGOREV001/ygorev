...
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010147
local YGOREV_FUSION_MAT2=100010084
...
function s.initial_effect(c)
	...
	c:RegisterEffect(e0)
	-- Cannot be destroyed by battle, except by a LIGHT monster OR a Level 7 or higher monster
	local e2=Effect.CreateEffect(c)
	e2:SetType(EFFECT_TYPE_SINGLE)
	e2:SetCode(EFFECT_INDESTRUCTABLE_BATTLE)
	e2:SetValue(function(_,c) return not (c:IsAttribute(ATTRIBUTE_LIGHT) or c:IsLevelAbove(7)) end)
	c:RegisterEffect(e2)
end
