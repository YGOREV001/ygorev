...
function s.initial_effect(c)
	...
	e1:SetCondition(function(e)return Duel.IsExistingMatchingCard(aux.FilterFaceupFunction(Card.IsCode,YGOREV_CARD_UMI),e:GetHandlerPlayer(),LOCATION_FZONE,LOCATION_FZONE,1,nil)end)
	e1:SetValue(400)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
