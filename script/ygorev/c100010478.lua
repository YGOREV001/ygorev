--Kwagar Hercules
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010041
local YGOREV_FUSION_MAT2=100010251
...
--3+: If this card would be destroyed, you can discard 1 Insect instead
...
--4+: [OPT] You can return all cards your opponent controls to their hand
function s.thcon(e)
...
function s.thop(e,tp,eg,ep,ev,re,r,rp)
	local sg=Duel.GetMatchingGroup(s.thfilter,tp,0,LOCATION_ONFIELD,e:GetHandler())
