--Gate Guardian
local s,id=GetID()
local YGOREV_FUSION_MAT1=100015007
local YGOREV_FUSION_MAT2=100015033
local YGOREV_FUSION_MAT3=100015042
...
function s.spfilter2(c,mat1)
	return c:IsCode(YGOREV_FUSION_MAT1,YGOREV_FUSION_MAT2,YGOREV_FUSION_MAT3) and c:IsAbleToGrave() and (c:IsLocation(LOCATION_ONFIELD) and c:IsFaceup()) and c:GetCode()~=mat1
end
...
function s.condition(e,c)
	...
	local g3=Duel.GetMatchingGroup(s.spfilter3,tp,LOCATION_ONFIELD,0,nil)
	local g=g1:Clone()
	g:Merge(g2)
	g:Merge(g3)
...
s.listed_names={YGOREV_CARD_SUIJIN,YGOREV_CARD_KAZEJIN,YGOREV_CARD_SANGA}
--Card Effects--START
--When your opponent activates a card or effect: You can shuffle 1 "Kazejin", "Sanga of the Thunder" or "Suijin" from your Graveyard to your Deck; negate it
...
function s.costfilter(c)
	return c:IsCode(YGOREV_CARD_SUIJIN,YGOREV_CARD_KAZEJIN,YGOREV_CARD_SANGA) and c:IsAbleToDeckAsCost()
end
