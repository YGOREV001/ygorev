--Boulder Tortoise
local s,id=GetID()
local YGOREV_FUSION_MAT1=100010062
local YGOREV_FUSION_MAT2=100010004
...
--Gains 100 DEF for each Rock monster in your Graveyard
function s.deffilter(c,e,tp)
	return c:IsRace(RACE_ROCK)
end
function s.defval(e,c)
	return Duel.GetMatchingGroupCount(s.deffilter,e:GetHandlerPlayer(),LOCATION_GRAVE,0,nil)*100
end
